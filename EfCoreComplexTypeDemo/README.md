...
* Check the `ConnectionStrings` in `appsettings.json` files under the `ComplexTypeDemo` project and change it if you need.
...
* The application needs to connect to a database. Run the following command in the `ComplexTypeDemo` directory:
